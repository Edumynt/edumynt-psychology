...
export const SITE: SiteConfig = {
  ...
  title: 'Psychology by Edumynt',
  /** Site tagline / description. */
  description:
    'Psychology made so simple that a 5-year-old can understand the idea and an exam student can remember it.',
  /** Author/handle shown in footer + meta. */
  author: {
    name: 'Edumynt',
    url: GITHUB_HANDLE ? `https://github.com/${GITHUB_HANDLE}` : undefined,
    avatar: avatarImg,
    bio: 'Psychology made so simple that a 5-year-old can understand the idea and an exam student can remember it.',
  },
  /** Default OG image. */
