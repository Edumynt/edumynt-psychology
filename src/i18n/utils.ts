 ...
 *   localizedPath('/posts/foo', 'hi') -> '/hi/posts/foo'
 *   localizedPath('/', 'hi')          -> '/hi/'
 *
 ...
 * Anything starting with `/hi` or `/hi/` resolves to 'hi'; otherwise
 ...
 *
 *   stripLocale('/hi/posts/foo')  -> '/posts/foo'
