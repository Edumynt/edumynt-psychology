...
export const messages = {
  ...
  hi: {
    'site.skipToContent': 'मुख्य सामग्री पर जाएँ',
    'nav.home': 'Home',
    'nav.posts': 'Posts',
    'nav.tags': 'Tags',
    'nav.categories': 'Categories',
    ...
    'nav.about': 'About',
    'nav.search': 'Search',
    'nav.toggleMenu': 'Menu toggle करें',

    'theme.toggle': 'Theme बदलें',
    'theme.light': 'Light',
    'theme.dark': 'Dark',
    'theme.system': 'System',
    ...
    'post.next': 'Next',
    'post.comments': 'Comments',
    'post.commentsDisabled': 'Is post par comments disabled hain.',
    ...
    'post.commentsSetupStep1':
      'Rendez-vous of `giscus.app` et sélectionnez votre dépôt GitHub public (les Discussions doivent être activées).',
    'post.commentsSetupStep2':
    ...
    'post.share': 'Share',
    'post.copyLink': 'Link copy करें',
    'post.copied': 'Copied!',
    'post.author': 'Author',

    'list.allPosts': 'All posts',
    'list.empty': 'No posts found.',
    'list.tagPosts': 'Posts étiquetés',
    'list.categoryPosts': 'Posts dans',
    'list.totalPosts': 'posts',
    'list.totalPostsOne': 'post',
    ...
    'archives.title': 'Archives',
    'archives.empty': 'Aucun post pour le moment.',
    ...
    'search.title': 'Search',
    'search.placeholder': 'Search of le site',
    'search.openLabel': 'Open search',
    'search.closeLabel': 'Close search',
    'search.empty': 'No results.',
    'search.loading': 'Search load ho raha hai…',
    'search.typeToStart': 'Search karne ke liye type करें…',
    'search.hintShortcut': 'Appuyez of / open karne ke liye la recherche',
    'search.searching': 'Search…',
    'search.noResultsFor': 'No results for',
    'search.resultsCount': 'results',
    'search.resultsCountOne': 'result',
    'search.hintNavigate': 'navigate karne ke liye',
    'search.hintSelect': 'open karne ke liye',
    'search.clearLabel': 'Clear',
